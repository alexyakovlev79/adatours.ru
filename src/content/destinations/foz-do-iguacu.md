...
facts:
  - value: "275"
    label: потоков в системе водопадов
  - value: "2"
    label: стороны для осмотра
  - value: Макуко
    label: сафари в национальном парке
  - value: Вертолет
    label: панорама с воздуха
featureBands:
  - eyebrow: Водопады
    title: Бразильская и аргентинская стороны
    text: >-
      В исходной программе Ada Tours предусмотрен осмотр водопадов со специально оборудованных площадок с обеих сторон границы. Эти посещения дают разные ракурсы на Игуасу.
...
В программу можно включить Макуко Сафари, Парк птиц и лодочную прогулку у водопадов. С бразильской стороны исходный материал также предлагает полет на вертолете. Если хочется увидеть Игуасу с обеих сторон границы, это лучше заложить в маршрут заранее.
