---
id: destination_brazil_costa_do_sauipe
locale: ru
name: Коста-ду-Сауипе
slug: costa-do-sauipe
status: approved
...
facts:
  - value: "70 км"
    label: примерно от Сальвадора по исходному материалу
  - value: Баия
...
Коста-ду-Сауипе находится в штате Баия, примерно в 70 км от Сальвадора по исходному материалу Ada Tours. Курорт описан через пляжи, песчаные дюны, кокосовые рощи, небольшие озера и тропическую растительность.

Кроме отдыха у моря, здесь собран широкий набор активностей: теннис, гольф, верховая езда, велосипеды и водные виды спорта. В отелях также предусмотрены фитнес и SPA-программы.

Коста-ду-Сауипе удобно соединять с Сальвадором в одной поездке. Такой маршрут дает сначала культурную и городскую часть Баии, затем несколько дней более спокойного отдыха на побережье.
